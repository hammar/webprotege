...
public class XdServiceManager {
    ...
    // Force server to update imports closure cache for project
    public void cacheImports(ProjectId projectId, AsyncCallback<Void> cb) {
    	proxy.cacheImports(projectId, cb);
    }
